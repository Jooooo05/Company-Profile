  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-x-0 -top-50 z-10 flex justify-center py-16 sm:py-20 lg:py-24">
        <div className="w-4/5 bg-linear-to-r from-[#16264A] via-[#3B3B4A]/95 to-[#8B5A3C] p-8 shadow-2xl sm:p-10 lg:p-12">
          ...
          <Link
            href="#certificates"
            className="mt-8 inline-flex items-center gap-2 bg-white px-6 py-3 text-[13px] font-semibold uppercase tracking-wide text-[#0A2647] transition-colors hover:bg-[#F2F0E8] focus-visible:outline focus-visible:outline-offset-2 focus-visible:outline-[#E85D25]"
          >
